# Generated by Django 5.1.7 on 2025-03-25 02:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations', to='chatsphere.bot')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='chatsphere.bot')),
            ],
        ),
        migrations.CreateModel(
            name='Chunk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='legacy_messages', to='chatsphere.chatroom')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='legacy_messages', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['timestamp'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('metadata', models.JSONField(default=dict)),
                ('conversation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='chatsphere.conversation')),
            ],
            options={
                'ordering': ['timestamp'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subscription_status', models.CharField(choices=[('free', 'Free'), ('active', 'Active'), ('canceled', 'Canceled'), ('trialing', 'Trialing'), ('past_due', 'Past Due')], default='free', max_length=20)),
                ('stripe_customer_id', models.CharField(blank=True, max_length=100, null=True)),
                ('subscription_plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='chatsphere.subscriptionplan')),
