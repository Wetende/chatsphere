...
@router.post("/", summary="Chat with a bot", description="Generate a response from the AI using retrieved context.")
...
@router.post("/stream", summary="Stream a chat response", description="Server-sent event stream that returns the AI response in chunks.")
